...
const giftCardTemplate = {
	...
	description: 'Qintronics eGift Card that can be used to purchase millions of items.',
	message: '',
...
function setupCartFunctionality() {
	...
	window.addToCart = function () {
		...
		if (
			...
			!to ||
			!selectedCard ||
			(sendToRecipient && (!emailInput || !confirmEmailInput || emailInput !== confirmEmailInput))
		) {
		...
		console.log('Cart items after addition:', JSON.parse(localStorage.getItem('cartItems')));
		updateCartDisplay(cartItems);
